...
set tracefd [open assignment1.tr w]
$ns_ trace-all $tracefd

set namtrace [open assignment1.nam w]
...
$ns_ at 0.0 "$node_(3) label NODE3"
...
$ns_ at 0.0 "$node_(1) add-mark m1 yellow circle"
$ns_ at 0.0 "$node_(2) add-mark m1 green circle"
$ns_ at 0.0 "$node_(3) add-mark m1 grey circle"
...
$ns_ at 2.5  "$cbr1(2) start"
$ns_ at 3.0  "$cbr1(3) start"
$ns_ at 3.5  "$cbr1(4) start"
$ns_ at 4.0  "$cbr1(5) start"
$ns_ at 4.5  "$cbr1(6) start"
$ns_ at 5.5  "$cbr1(7) start"
$ns_ at 6.0  "$cbr1(8) start"
$ns_ at 7.0 "$cbr1(9) start"
